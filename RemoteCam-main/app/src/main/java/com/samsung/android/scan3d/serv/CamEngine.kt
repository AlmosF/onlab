...
class CamEngine(val context: Context) {
    ...
    var cameraList = listOf(
        Selector.SensorDesc("Back", "0", CameraCharacteristics.LENS_FACING_BACK),
        Selector.SensorDesc("Front", "1", CameraCharacteristics.LENS_FACING_FRONT)
    )
